        ...
        <header class="header fade-in">
            <div class="header-container">
                <a href="./" class="logo">
                    ...
                    <span>Protoentertainments.com</span>
                </a>
                
                <nav class="nav">
                    <ul class="nav-list">
                        <li><a href="./" class="nav-link">Home</a></li>
                        <li><a href="./scooter-news.html" class="nav-link">Updates</a></li>
                        <li><a href="./scooter-contacts.html" class="nav-link">Contact</a></li>
                    </ul>
                </nav>
            ...
            <div class="mobile-menu">
                <div class="mobile-menu-content">
                    ...
                    <ul class="mobile-menu-list">
                        ...
                        <li><a href="./scooter-news.html" class="mobile-menu-link">Updates</a></li>
                        <li><a href="./scooter-contacts.html" class="mobile-menu-link">Contact</a></li>
                    </ul>
                </div>
            </div>
        </header>
