  ...
  cookieBanner.innerHTML = `
    <div class="cookie-banner-content">
      <div class="cookie-text">
        <strong>🛴 We use cookies</strong> to enhance your scooter gaming experience and analyze site traffic. 
        By continuing to use this site, you consent to our use of cookies. 
        <a href="./scooter-cookies.html" target="_blank">Learn more</a>
      </div>
      <div class="cookie-buttons">
        <button class="cookie-btn decline" aria-label="Decline cookies">Decline</button>
        <a href="./scooter-cookies.html" class="cookie-btn learn-more" aria-label="Learn more about cookies">Learn More</a>
