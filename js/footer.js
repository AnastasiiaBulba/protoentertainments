            ...
            <div class="footer-container">
                <div class="footer-content">
                    <div class="footer-section">
                        ...
                        <div class="footer-contact">
                            <div class="contact-item">
                                ...
                                <div class="contact-text">contact@protoentertainments.com</div>
                            </div>
                            <div class="contact-item">
                                <div class="contact-icon">📞</div>
                                <div class="contact-text">+61 99 636 1234</div>
                            </div>
                            <div class="contact-item">
                                <div class="contact-icon">📍</div>
                                <div class="contact-text">
                                    17 Ocean Road<br>
                                    Apollo Bay VIC 3233<br>
                                    Australia
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="footer-section">
                        ...
                        <div class="footer-links">
                            <a href="./scooter-cookies.html" class="footer-link">Cookie Policy</a>
                            <a href="./scooter-privacy.html" class="footer-link">Privacy Policy</a>
                            <a href="./scooter-disclaimer.html" class="footer-link">Disclaimer</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-bottom">
                    <div class="copyright">
                        ...
                        Protoentertainments.com. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
